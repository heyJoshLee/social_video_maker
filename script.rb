...
CSV.foreach("list.csv") do |row|
  ...
  if File.file?(dir_name + "video.mp4")
    system("mencoder -oac pcm -ovc x264  #{dir_name}intro.mp4 #{dir_name}video.mp4 outtros/facebook.m4v -o #{dir_name}full_movie_fb.mp4")
  elsif File.file?(dir_name + "video.m4v")
    system("mencoder -oac pcm -ovc x264  #{dir_name}intro.mp4 #{dir_name}video.m4v outtros/facebook.m4v -o #{dir_name}full_movie_fb.mp4")
  end
  ...
  if File.file?(dir_name + "video.mp4")
    ...
    system("mencoder -oac pcm -ovc x264  #{dir_name}intro.mp4 #{dir_name}video.m4v outtros/youtube.m4v -o #{dir_name}full_movie_yt.mp4")
  end
