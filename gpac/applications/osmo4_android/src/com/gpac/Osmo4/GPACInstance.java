/**
 * $URL: https://svn.code.sf.net/p/gpac/code/trunk/gpac/applications/osmo4_android/src/com/gpac/Osmo4/GPACInstance.java $
 *
 * $LastChangedBy: jeanlf $ - $LastChangedDate: 2014-12-11 22:23:39 +0800 (四, 11 十二 2014) $
 */
    ...
    synchronized static Map<String, Throwable> loadAllLibraries(GpacConfig config) {
        ...
        if (!exceptions.isEmpty()) {
            try {
                ...
                out.println("$Revision: 5552 $"); //$NON-NLS-1$
