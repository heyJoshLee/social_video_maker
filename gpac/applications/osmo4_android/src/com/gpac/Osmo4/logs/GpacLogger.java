/**
 * $URL: https://svn.code.sf.net/p/gpac/code/trunk/gpac/applications/osmo4_android/src/com/gpac/Osmo4/logs/GpacLogger.java $
 *
...
public class GpacLogger {
    ...
    public void onCreate() {
        ...
        if (writer != null)
            writer.println("New log $Revision: 4029 $ at " + new Date()); //$NON-NLS-1$
    }
